...
public class EncodingSuite {
    ...
    public void runSuite()  {
        ...
        String keyFilePath = "oral_exam1/S102_OneTimePad_Hard/keyFiles"; //strings to hold the exact file path of the two file folders, as exactly specified on the machine
        String messageFilePath ="oral_exam1/S102_OneTimePad_Hard/messages"; //learned the hard way that LINUX filepaths arent the same as windows
